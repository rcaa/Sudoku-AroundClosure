...
public privileged aspect SolverFeature {
	...
	pointcut hook_solveSudokuGenerator(Board board, BoardManager bm) 
	 : execution(* BoardManager.hook_solveSudokuGenerator(..)) && args(board, bm);
